...
<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="44" height="44" style="display: block;">
    <g stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M109.64,352a45.06,45.06,0,0,0-26.35,12.84C65.67,382.52,64,448,64,448s65.52-1.67,83.15-19.31A44.73,44.73,0,0,0,160,402.32" fill="none" stroke="#A09BA8" stroke-width="32"></path>
    </g>
</svg>
"""
# """
